...
if (!function_exists('sports_schema_statements')) {
    function sports_schema_statements(): array {
        return [
...
if (!function_exists('ensure_sports_schema')) {
    function ensure_sports_schema(PDO $pdo): void {
        foreach (sports_schema_statements() as $statement) {
            $pdo->exec($statement);
        }
    }
}
